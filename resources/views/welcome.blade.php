        ...
        <div class="flex justify-between items-center h-20">
            ...
            <div class="relative flex items-center gap-4">
                ...
                <button 
                    ...
                    class="flex items-center gap-3 px-4 py-2.5 rounded-xl border-2 border-orange-300 hover:border-orange-500 hover:bg-orange-50 transition-all duration-200 group shadow-sm">
                    ...
                    <div class="hidden md:block text-left">
                        <p class="font-bold text-base leading-tight text-gray-900">
                            {{ Auth::user()->name }}
                        </p>
                        <div class="flex items-center gap-1.5 mt-1">
                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-md text-xs font-bold bg-orange-100 text-orange-700 border border-orange-300">
                    ...
                    <!-- Dropdown Icon -->
                    <svg id="dropdownIconWelcome" class="w-5 h-5 text-gray-700 transition-transform duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
