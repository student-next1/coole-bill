    ...
    <div class="max-w-7xl mx-auto px-6 lg:px-8">
        <div class="flex justify-between items-center h-20">
            ...
            <div class="relative flex items-center gap-3">
                ...
                <div 
                    id="userMenuWelcome"
                    class="hidden absolute top-full right-0 mt-3 w-56 bg-white rounded-xl shadow-lg border border-slate-200 py-2 z-50 opacity-0 scale-95 transition-all duration-100">
