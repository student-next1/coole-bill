<header class="sticky top-0 z-40 bg-white dark:bg-slate-800 border-b border-slate-200 dark:border-slate-700 shadow-sm">
    ...
    <div class="px-4 md:px-8 py-4 flex items-center justify-between">
        ...
        <div class="relative">
            <button 
                id="userMenuButton"
                class="flex items-center gap-3 px-3 py-2 rounded-xl hover:bg-slate-50 dark:hover:bg-slate-700 transition-all duration-200 group">
            ...
            <div 
                ...
                <!-- Menu Items -->
                <a href="{{ route('dashboard') }}" class="flex items-center gap-3 px-4 py-2.5 text-sm text-gray-700 dark:text-gray-300 hover:bg-slate-50 dark:hover:bg-slate-700 transition-colors">
                ...
                <a href="{{ route('users.index') }}" class="flex items-center gap-3 px-4 py-2.5 text-sm text-gray-700 dark:text-gray-300 hover:bg-slate-50 dark:hover:bg-slate-700 transition-colors">
                    <svg class="w-5 h-5 text-gray-500 dark:text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="px-4 py-2">
                    ...
                    <button 
                        id="resetThemeBtn"
                        class="w-full px-3 py-2 rounded-lg text-xs font-medium bg-red-100 dark:bg-red-900/20 text-red-700 dark:text-red-400 hover:bg-red-200 dark:hover:bg-red-900/30">
                        🔄 Reset Tema
                    </button>
                </div>
