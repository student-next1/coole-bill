...
<div class="space-y-6">
            ...
            <a href="{{ route('transaksi.create') }}" 
               class="group relative overflow-hidden bg-gradient-to-br from-orange-50 to-orange-100 border-2 border-orange-200 rounded-xl p-6 hover:shadow-lg hover:scale-105 transition-all duration-200">
                ...
                <div class="relative">
                    ...
                    <p class="text-sm text-gray-600">Mulai penjualan baru</p>
                </div>
            </a>
            ...
            <a href="{{ route('produk.index') }}" 
               class="group relative overflow-hidden bg-gradient-to-br from-blue-50 to-blue-100 border-2 border-blue-200 rounded-xl p-6 hover:shadow-lg hover:scale-105 transition-all duration-200">
                ...
                <div class="relative">
                    ...
                    <p class="text-sm text-gray-600">Lihat & edit produk</p>
                </div>
            </a>
            @endif
            ...
            <a href="{{ route('transaksi.index') }}" 
               class="group relative overflow-hidden bg-gradient-to-br from-green-50 to-green-100 border-2 border-green-200 rounded-xl p-6 hover:shadow-lg hover:scale-105 transition-all duration-200">
                ...
                <div class="relative">
                    ...
                    <h4 class="font-bold text-gray-900 mb-1">Riwayat Transaksi</h4>
    ...
    <div class="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 lg:gap-6">
        ...
        <div class="group relative bg-white rounded-xl shadow-sm hover:shadow-md border border-slate-200 p-6 transition-all duration-300">
            ...
            @if($stokRendah > 0)
            <p class="text-xs text-red-600 mt-2 font-medium">{{ $stokRendah }} stok rendah</p>
            @endif
        </div>
        ...
        <div class="group relative bg-white rounded-xl shadow-sm hover:shadow-md border border-slate-200 p-6 transition-all duration-300">
            <div class="flex items-center justify-between mb-4">
                ...
                <span class="text-xs font-semibold text-purple-600 bg-purple-50 px-3 py-1 rounded-full">Kategori</span>
            </div>
    ...
    <!-- Stock Alert & System Info & Recent Transactions - 3 Columns -->
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div>
            ...
            <div class="bg-gradient-to-br from-slate-800 to-slate-900 rounded-xl p-6 min-h-57" style="background: linear-gradient(to bottom right, #1e293b, #0f172a) !important;">
                <div class="flex items-center gap-3 mb-4">
                    ...
                    <div class="min-w-0">
                        <h4 class="font-bold text-sm truncate" style="color: #ffffff !important;">Kartu Pembayaran</h4>
                        <p class="text-xs" style="color: #94a3b8 !important;">Total aktif</p>
                    </div>
                </div>
                <div class="text-3xl font-black mb-2" style="color: #ffffff !important;">{{ number_format($totalKartu) }}</div>
                <a href="{{ route('payment-cards.index') }}" class="text-xs font-medium" style="color: #fb923c !important;">
                    Kelola Kartu →
                </a>
            </div>
        </div>
        ...
        <div class="lg:row-span-2">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-6 h-full">
                ...
                <div class="space-y-3">
                    @foreach($transaksiTerbaru->take(3) as $transaksi)
                    <div class="p-3 border border-slate-100 rounded-xl hover:bg-slate-50 transition-colors">
                        <div class="flex items-start justify-between mb-2">
                            ...
                            <span class="text-xs bg-blue-100 text-blue-700 px-2 py-1 rounded-lg font-medium flex-shrink-0 ml-2">Tunai</span>
                            @else
                            <span class="text-xs bg-green-100 text-green-700 px-2 py-1 rounded-lg font-medium flex-shrink-0 ml-2">Kartu</span>
                            @endif
                        </div>
        ...
        <!-- Produk Terlaris - Positioned Below Stock Alert & Payment Cards -->
        <div class="md:col-span-2 lg:col-span-2 lg:row-start-2">
            <!-- Produk Terlaris -->
            <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
                <div class="flex items-center justify-between mb-5">
                    <h3 class="text-lg font-bold text-gray-900">Produk Terlaris Bulan Ini</h3>
                ...
                <div class="space-y-3">
                    ...
                    <div class="flex items-center gap-4 p-4 rounded-xl hover:bg-slate-50 transition-colors border border-slate-100">
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <p class="text-sm text-gray-500">Terjual {{ number_format($item->total_qty) }} unit</p>
                        </div>
