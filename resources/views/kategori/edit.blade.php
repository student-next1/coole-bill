...
<div class="max-w-2xl mx-auto">
    ...
    <div class="mb-8">
        ...
        <p class="text-sm text-gray-600 mt-2">Perbarui informasi kategori di bawah</p>
    </div>
        ...
        <form action="{{ route('kategori.update', $kategori->id) }}" method="POST">
            ...
            <div class="mb-6">
                ...
                <textarea name="deskripsi" 
                          ...
                          rows="4"
                          class="w-full px-4 py-2 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500 text-sm">{{ old('deskripsi', $kategori->deskripsi) }}</textarea>
            </div>
